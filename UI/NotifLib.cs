...
namespace GTAG_NotificationLib
{
    public class NotifiLib : MonoBehaviour
    {
        ...
        int NotificationDecayTime = 275;
        int NotificationDecayTimeCounter = 275;
        public static int NoticationThreshold = 10; //Amount of notifications before they stop queuing up
        string[] Notifilines;
        string newtext;
        ...
        public static void SendNotification(string NotificationText)
        {
            ...
            {
                if (!Mods.jikoisblackbutalsonotblack)
                {
